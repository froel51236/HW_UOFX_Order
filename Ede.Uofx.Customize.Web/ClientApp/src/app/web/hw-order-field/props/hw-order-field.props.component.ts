...
@Component({
  selector: 'uofx-hw-order-field-props-component',
  templateUrl: './hw-order-field.props.component.html',
})

/*修改*/
/*置換class名稱，exProps的interface名稱*/
export class HwOrderFieldPropsComponent
...
/*修改*/
/*置換interface名稱*/
export interface HwOrderFieldExProps {
  isShowHelloWorld: boolean;
}
