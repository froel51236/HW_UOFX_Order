...
namespace Ede.Uofx.Customize.Web.Extensions
{
    public class ApiSignatureMiddleware
    {
        ...
        const string apikey = "UOFXBPMSite";
        ...
        public async Task Invoke(HttpContext context)
        {
            ...
            if (!context.Request.Headers.TryGetValue("XSiteSignature", out var XSiteSignature))
            {
                //如果沒有XSite-Signature驗證的話，改驗證X-Signature、X-Timestamp
